...
public class SchemeSoftAdapter extends BaseQuickAdapter<SchemeDetailBean.RuanBean, BaseViewHolder> {
    public SchemeSoftAdapter(List<SchemeDetailBean.RuanBean> data) {
        super(R.layout.adapter_scheme_body_detail, data);
    }

    @Override
    protected void convert(BaseViewHolder baseViewHolder, SchemeDetailBean.RuanBean bean) {
